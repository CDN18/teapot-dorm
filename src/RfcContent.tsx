// Extracted from https://datatracker.ietf.org/doc/html/rfc7168
export const rfcContent = `<div class="rfcmarkup"><pre>Independent Submission                                          I. Nazar
Request for Comments: 7168                                  1 April 2014
Updates: <a href="https://datatracker.ietf.org/doc/html/rfc2324">2324</a>
...
Status of This Memo
   ...
   Standard; see <a href="https://datatracker.ietf.org/doc/html/rfc5741#section-2">Section&nbsp;2 of RFC 5741</a>.
...
<span class="grey"><a href="https://datatracker.ietf.org/doc/html/rfc7168">RFC 7168</a>                       HTCPCP-TEA                   1 April 2014</span>
...
<span class="h2" id="autoid-1"><a class="selflink" id="section-1" href="#section-1">1</a>.  Introduction</span>

   As noted in the Hyper Text Coffee Pot Control Protocol [<a href="#ref-HTCPCP" data-bs-original-title="&quot;Hyper Text Coffee Pot Control Protocol (HTCPCP/1.0)&quot;">HTCPCP</a>],
...
<span class="h3" id="autoid-2"><a class="selflink" id="section-1.1" href="#section-1.1">1.1</a>.  Terminology</span>

   The key words "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT",
   "SHOULD", "SHOULD NOT", "RECOMMENDED", "MAY", and "OPTIONAL" in this
   document are to be interpreted as described in <a href="https://datatracker.ietf.org/doc/html/rfc2119">RFC 2119</a> [<a href="#ref-KEYWORDS" data-bs-original-title="&quot;Key words for use in RFCs to Indicate Requirement Levels&quot;">KEYWORDS</a>].

<span class="h2" id="autoid-3"><a class="selflink" id="section-2" href="#section-2">2</a>.  HTCPCP-TEA Protocol Additions</span>

   The TEA extension to HTCPCP adapts the operation of certain HTCPCP
   methods.

<span class="h3" id="autoid-4"><a class="selflink" id="section-2.1" href="#section-2.1">2.1</a>.  BREW and POST Methods</span>
...
<span class="h4" id="autoid-5"><a class="selflink" id="section-2.1.1" href="#section-2.1.1">2.1.1</a>.  The "/" URI</span>

   For the URI "/", brewing will not commence.  Instead, an Alternates
   header as defined in <a href="https://datatracker.ietf.org/doc/html/rfc2295">RFC 2295</a> [<a href="https://datatracker.ietf.org/doc/html/rfc2295" data-bs-original-title="&quot;Transparent Content Negotiation in HTTP&quot;">RFC2295</a>] MUST be sent, with the
...
<span class="h4" id="autoid-6"><a class="selflink" id="section-2.1.2" href="#section-2.1.2">2.1.2</a>.  Variety-Specific URIs</span>
...
<span class="h3" id="autoid-7"><a class="selflink" id="section-2.2" href="#section-2.2">2.2</a>.  Modified Header Fields</span>

   HTCPCP-TEA modifies the definition of one header field from the base
   HTCPCP specification.

<span class="h4" id="autoid-8"><a class="selflink" id="section-2.2.1" href="#section-2.2.1">2.2.1</a>.  The Accept-Additions Header Field</span>
...
<span class="h3" id="autoid-9"><a class="selflink" id="section-2.3" href="#section-2.3">2.3</a>.  Response Codes</span>

   HTCPCP-TEA makes use of normal HTTP error codes and those defined in
   the base HTCPCP specification.

<span class="h4" id="autoid-10"><a class="selflink" id="section-2.3.1" href="#section-2.3.1">2.3.1</a>.  300 Multiple Options</span>
...
<span class="h4" id="autoid-11"><a class="selflink" id="section-2.3.2" href="#section-2.3.2">2.3.2</a>.  403 Forbidden</span>
...
<span class="h4" id="autoid-12"><a class="selflink" id="section-2.3.3" href="#section-2.3.3">2.3.3</a>.  418 I'm a Teapot</span>
...
<span class="h2" id="autoid-13"><a class="selflink" id="section-3" href="#section-3">3</a>.  The "message/teapot" Media Type</span>
...
<span class="h2" id="autoid-14"><a class="selflink" id="section-4" href="#section-4">4</a>.  Environmental Considerations</span>
...
<span class="h2" id="autoid-15"><a class="selflink" id="section-5" href="#section-5">5</a>.  Security Considerations</span>
...
<span class="h2" id="autoid-16"><a class="selflink" id="section-6" href="#section-6">6</a>.  Acknowledgements</span>
...
<span class="h2" id="autoid-17"><a class="selflink" id="section-7" href="#section-7">7</a>.  References</span>

<span class="h3" id="autoid-18"><a class="selflink" id="section-7.1" href="#section-7.1">7.1</a>.  Normative References</span>
...
<span class="h3" id="autoid-19"><a class="selflink" id="section-7.2" href="#section-7.2">7.2</a>.  Informative References</span>

   [<a id="ref-HTCPCP">HTCPCP</a>]   Masinter, L., "Hyper Text Coffee Pot Control Protocol
              (HTCPCP/1.0)", <a href="https://datatracker.ietf.org/doc/html/rfc2324">RFC 2324</a>, April 1 1998.

   [<a id="ref-RFC2295">RFC2295</a>]  Holtman, K. and A. Mutz, "Transparent Content Negotiation
              in HTTP", <a href="https://datatracker.ietf.org/doc/html/rfc2295">RFC 2295</a>, March 1998.
